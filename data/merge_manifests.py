...
parser.add_argument('--merge-dir', default='manifests/',
...
parser.add_argument('--output-path', default='merged_manifest.csv',
...
file_paths = order_and_prune_files(
    file_paths, args.min_duration, args.max_duration)
